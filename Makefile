main: main.o game.o sprite.o map.o meta_data.o data_protocol.o network.o utils.o read_write_on_bit.o  md5.o
...
meta_data.o:def.h meta_data.h read_write_on_bit.h md5.h
	g++ meta_data.cpp read_write_on_bit.cpp md5.cpp -c -Wall
